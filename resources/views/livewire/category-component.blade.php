                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            ...
                            <div class="single-post clearfix">
                                ...
                                <div class="content pt-10">
                                    <h5><a href="{{ route('product.details',['slug'=>$category->slug]) }}">Chen Cardigan</a></h5>
                            ...
                            <div class="single-post clearfix">
                                ...
                                <div class="content pt-10">
                                    <h6><a href="{{ route('product.details',['slug'=>$category->slug]) }}">Chen Sweater</a></h6>
                            ...
                            <div class="single-post clearfix">
                                ...
                                <div class="content pt-10">
                                    <h6><a href="{{ route('product.details',['slug'=>$category->slug]) }}">Colorful Jacket</a></h6>
